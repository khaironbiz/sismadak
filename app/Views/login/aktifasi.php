                ...
                <div class="card-body login-card-body" style="border-radius: 10px;">
                    <div class="login-logo">
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <img src="<?= base_url('assets/upload/image/' . $site['icon']) ?>" class="img img-fluid w-75">
                            </div>
                        </div>
                    </div>
                    <hr>
                    <p class="login-box-msg"><?= $registrasi['nama'] ?></p>
                    <?= '<span class="text-danger">' . \Config\Services::validation()->listErrors() . '</span>'; ?>
                    <?= form_open(base_url('login/aktifkan/'.$registrasi['has_registrasi'])); ?>
                    <?= csrf_field() ?>
